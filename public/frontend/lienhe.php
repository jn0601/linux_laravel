...
<div id="page-wrapper"><!-- Jumbotron -->
   ...
   <div class="page page_lienhe pb-0">
         ...
         <div class="row">
            <div class="col-lg-5 justify-content-center align-self-center text-lg-left text-sm-center text-xs-center">
               ...
               <ul class="list-unstyled mt-3 list-contact colored-icons">
                  <li><i class="fa fa-envelope margin-icon"></i><a href="mailto:admin@demo.web30s.vn">admin@demo.web30s.vn</a></li>
            ...
            <div class="contact-info col-lg-6 offset-lg-1 res-margin notepad">
               ...
               <div id="contact_form">
                  <div class="form-group">
                     ...
                     <button type="submit" id="submit_btn" value="Submit" class="btn btn-primary">Gửi tin nhắn</button>
                  </div>
                  <!-- /form-group-->
                  <!-- Contact results -->
      ...
      <div id="maps" class="container-fluid">
         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.8146167973664!2d106.72653431535171!3d10.748766462641512!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f3ad1865b55%3A0x312e2babd77bc83b!2zQ8O0bmcgdHkgUC5BIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1655085190412!5m2!1svi!2s" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>   
      </div>
      <!-- /map-->
   </div>
   <!-- /page --></div>
