               ...
               <div class="notepad mt-5"  data-aos="zoom-out">
                  <div class="row">
                     ...
                     <div class="col-lg-8">
                        ...
                        <a href="index.php?page=lienhe"  class="btn btn-tertiary">Liên hệ chúng tôi</a>
                     </div>
                     <!-- /col-lg-->
                  </div>
                  <!-- /row -->
   ...
   <div class="container block-padding">
      ...
      <div class="row">
         ...
         <div class="col-lg-6">
            ...
            <!-- buttons -->
            <a href="index.php?page=lienhe"  class="btn btn-tertiary">Liên hệ chúng tôi</a>
            <a href="index.php?page=doingu" class="btn-margin btn btn-quaternary ml-1" >Đội ngũ</a>
         </div>
         <!-- /col-lg-->
      </div>
      <!-- /row -->
