...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 06, 2023 at 10:01 AM
...
(1, 0, 'aaa aaaa', '', '', '', '', '', 6, 'menu 1', 1, 0, 1, 1),
(2, 1, 'bbb bbbbb', '', '', '', '', '', 5, 'menu 2', 1, 0, 2, 1),
(3, 2, 'ccc cccccc', '', '', '', '', '', 4, 'menu 3', 1, 0, 3, 1),
(4, 0, 'menu abc', 'menu-abc', '', '', '', '', 15, '352805347_272465948645658_9096286696674757798_n29.jpg', 1, 0, 4, 1),
(5, 2, 'menu vn', 'menu-vn', '', '', '', '', 15, '9753-front29.jpg', 1, 0, 5, 1),
(6, 4, 'menu lv2', 'menu-lv2', '', '', '', '', 15, '9753-front8.jpg', 1, 1, 6, 1),
(7, 6, 'test xoá menu 123', 'test-xoa-menu-123', 'test xoá menu 123', 'test xoá menu 123', 'test xoá menu 123', 'test xoá menu 123', 15, '352805347_272465948645658_9096286696674757798_n53.jpg', 1, 1, 7, 1);
...
(133, 15, 6, 'vn', 'menu lv2', '', '', 'menu-lv2', '', '', '', ''),
(134, 15, 6, 'en', 'menu lv2 en', '', '', 'menu-lv2-en', '', '', '', ''),
(135, 15, 7, 'vn', 'test xoá menu 123', '', '', 'test-xoa-menu-123', 'test xoá menu 123', 'test xoá menu 123', 'test xoá menu 123', 'test xoá menu 123'),
(136, 15, 7, 'en', 'test xoá menu en 456', '', '', 'test-xoa-menu-en-456', '', '', '', ''),
...
(8, 5, ',4,5,', 'test dm 123', '<p>test dm</p>\r\n\r\n<figure class=\"easyimage easyimage-full\"><img alt=\"\" src=\"blob:http://localhost/40d338bc-dbbf-48a4-8b4c-8b5110555075\" width=\"700\" />\r\n<figcaption></figcaption>\r\n</figure>\r\n\r\n<p>&nbsp;</p>', '<p>test dm</p>\r\n\r\n<figure class=\"easyimage easyimage-full\"><img alt=\"\" src=\"blob:http://localhost/7378ff1a-4bdb-4ddc-93a1-0160f1975dea\" width=\"922\" />\r\n<figcaption></figcaption>\r\n</figure>\r\n\r\n<p>&nbsp;</p>', 3, 4, '352805347_272465948645658_9096286696674757798_n34.jpg', 0, 1, 1, 20230706, 'test-dm-123', 'test dm', 'test dm', 'test dm');
...
(18, 15, 5, 'menu-vn', 1, 1),
(19, 15, 6, 'menu-lv2', 1, 1),
(20, 15, 7, 'test-xoa-menu-123', 1, 1),
