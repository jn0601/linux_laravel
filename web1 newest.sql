...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 05, 2023 at 10:24 AM
...
INSERT INTO `menus` (`id`, `parent_id`, `name`, `seo_name`, `type`, `icon`, `is_folder`, `is_horizontal`, `display_order`, `status`) VALUES
...
(100, 2, 9, 'en', '', '', '', '', '', '', '', ''),
(101, 2, 10, 'vn', 'new nodes', '<p>new nodes</p>', '<p>new nodes</p>', 'new-nodes', 'new nodes', 'new nodes', 'new nodes', 'new nodes'),
(102, 2, 10, 'en', '', '', '', '', '', '', '', ''),
...
(107, 2, 14, 'vn', 'basemodel', '<p>basemodel</p>', '<p>basemodel</p>', 'basemodel', 'basemodel', 'basemodel', 'basemodel', 'basemodel'),
...
(14, 0, 'basemodel', '<p>basemodel</p>', '<p>basemodel</p>', '9753-front94.jpg', 11, 1, ',', 0, 20230705, 20230705, 'basemodel', 'basemodel', 'basemodel', 'basemodel', 'basemodel');
