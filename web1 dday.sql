...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  `is_horizontal` smallint(6) NOT NULL,
  `display_order` int(11) NOT NULL,
  `status` smallint(6) NOT NULL,
  PRIMARY KEY (`id`)
...
(8, 10, 'test news', '<p>test news</p>', '<p>test news</p>', '352805347_272465948645658_9096286696674757798_n30.jpg', 7, 1, ',4', 0, 20230705, 20230705, 'test-news', 'test news', 'test news', 'test news', 'test news'),
...
(14, 10, 'basemodel', '<p>thfthfsth ftsrth rtyhrtsghrtgrtg rthrthtrhrtshtrh fghgdfjhgdhjdtgjtdj</p>', '<p>basemodel</p>', '9753-front94.jpg', 11, 1, ',', 2, 20230705, 20230705, 'basemodel', 'basemodel', 'basemodel', 'basemodel', 'basemodel'),
...
CREATE TABLE IF NOT EXISTS `news_categories` (
  ...
  `display_order` int(11) NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `representative` smallint(6) NOT NULL,
  `status` smallint(6) NOT NULL,
  `display_menu` smallint(6) NOT NULL,
  `date_created` int(11) NOT NULL,
  `seo_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `meta_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `meta_desc` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `nodes` (
  ...
  `seo_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` smallint(6) NOT NULL,
  `is_sitemap` smallint(6) NOT NULL,
  PRIMARY KEY (`id`)
...
(7, '5600x', 'Ryzen 5 5600x', '<p>Ryzen 5 5600x</p>', '<p>Ryzen 5 5600x</p>', 'o1Sx0GmTnr60.png', 2000, 3000, 2, 7, ',1', 1, 0, 20230630, 'ryzen-5-5600x', 'Ryzen 5 5600x', 'Ryzen 5 5600x', 'Ryzen 5 5600x', 'Ryzen 5 5600x'),
(11, '13600k', 'Intel Core i5 13600K / 3.5GHz Turbo 5.1GHz / 14 Nhân 20 Luồng / 24MB / LGA 1700', '<p>Intel Core i5 13600K / 3.5GHz Turbo 5.1GHz / 14 Nh&acirc;n 20 Luồng / 24MB / LGA 1700</p>', '<p>Intel Core i5 13600K / 3.5GHz Turbo 5.1GHz / 14 Nh&acirc;n 20 Luồng / 24MB / LGA 1700</p>\n\n<figure class=\"easyimage easyimage-full\"><img alt=\"\" src=\"blob:http://localhost/de89c1b0-f167-4777-9f98-703bb9dec3b0\" width=\"480\" />\n<figcaption></figcaption>\n</figure>\n\n<p>&nbsp;</p>', 'gearvn-intel-core-i5-13600k-3_610a0170cf6844caa7f4b8add912bc0e28.webp', 2000, 5000, 0, 8, ',2', 1, 1, 20230709, 'intel-core-i5-13600k-35ghz-turbo-51ghz-14-nhan-20-luong-24mb-lga-1700', 'Intel', 'Intel', 'Intel', 'Intel'),
(12, 'R5500', 'Ryzen 5 5500', '<p>Ryzen 5 5500</p>', '<p>Ryzen 5 5500</p>', 'o1Sx0GmTnr69.png', 2000, 5000, 5, 9, ',4', 1, 1, 20230709, 'ryzen-5-5500', 'Ryzen 5 5500', 'Ryzen 5 5500', 'Ryzen 5 5500', 'Ryzen 5 5500');
