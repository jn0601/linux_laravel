         ...
         <div class="row">
            ...
            <div class="col-lg-9 page-with-sidebar">
               <div class="col-md-12">
                  ...
                  <!-- Image -->
                  <!-- <p class="h7">Giá: {{$product->price_sale}} đ</p> -->
                  <p>{!!$product->desc!!}
                  </p>
                  <!-- row -->
                  <div class="row">
                     <div class="col-md-5">
                        <div class="col-md-12 carousel-1item owl-carousel owl-theme " data-aos="fade-in">
                           <img src="{{URL::to('public/backend/uploads/products/'.$product->image)}}" class="img-fluid rounded-circle" alt="">
                     ...
                     <!-- /col-md -->
                     <div class="col-md-7">
                        <h2 style="color: #e7373d">Giá: {{$product->price_sale}} đ</h2>
                        <!-- Image -->
                        ...
                        <div class="tag-socical container">
                           <div class="tag">
                              <ul style="padding: 0; margin: 0;">
                                 ...
                                 <li class="text2"><a href="#">{{$product->tags}}</a></li>
                              </ul>
                           </div>
                           <div class="socical">
                              <ul>
            ...
            <div id="sidebar" class="col-lg-3 h-50 sticky-top">
               ...
               <div class="widget-area notepad">
                  ...
                  <div class="list-group">
                     <a href="#" class="list-group-item list-group-item-action active">{{$related_name->name}}</a>
                  </div>
                  @endforeach
                  <!-- /list-group -->
               </div>
            ...
            <div class="carousel-3items owl-carousel owl-theme mt-0">
               ...
               <div class="serviceBox2">
                  ...
                  <div class="service-content">
                     ...
                     <!-- Button -->
                     <a href="{{URL::to('/san-pham/'.$related->seo_name)}}" class="btn btn-quaternary btn-sm mt-2 ml-1">Xem thêm</a>
                  </div>
               </div>
               @endforeach
               <!-- service 3  -->
