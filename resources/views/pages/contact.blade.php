      ...
      <div class="container block-padding">
         <div class="row">
            ...
            <div class="contact-info col-lg-6 offset-lg-1 res-margin notepad">
               ...
               <!-- Form Starts -->
               <form class="" enctype="multipart/form-data" action="{{URL::to('/save-contact')}}" method="post"
                  novalidate>
                  <div id="contact_form">
                     <div class="form-group">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <input type="number" name="phone" class="form-control input-field" required="">
                           </div>
                           <div class="col-md-6">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <label>Tiêu đề</label>*</span></label>
                              <input type="text" name="title" class="form-control input-field" required="">
                           </div>
                           <div class="col-md-12">
                              <label>Nội dung<span class="required">*</span></label>
                              <textarea name="content" id="message" class="textarea-field form-control" rows="3"
                                 required=""></textarea>
                           </div>
                           <div class="col-md-12">
                              <label>Ghi chú</label>*</span></label>
                              <input type="text" name="note" class="form-control input-field" required="">
                           </div>
                        </div>
