      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-9 blog-card page-with-sidebar">
               <h1 class="mb-2">{{$news->name}}</h1>
               <!-- Post info-->
               <div class="post-info text-muted">
                  <i class="fas fa-calendar margin-icon"></i>{{substr($news->date_created, -2)}}/{{substr($news->date_created, 4, -2)}}/{{substr($news->date_created, 0, 4)}}
                  <i class="fas fa-eye"></i> Lượt xem: {{$news->count_view}}
               </div>
               <hr>
               <!-- Preview Image -->
               <img src="{{URL::to('public/backend/uploads/news/'.$news->image)}}" class="img-fluid" alt="">
               <hr>
               <!-- Post Content -->
               <p>{!!$news->content!!}</p>
               <div class="tag-socical container">
                  <div class="tag">
                     <ul style="padding: 0; margin: 0;">
                        ...
                        <li class="text2"><a href="#">{{$news->tags}}</a></li>
                     </ul>
                  </div>
                  <div class="socical">
                     <ul>
            ...
            <div id="sidebar" class="col-lg-3 h-50 sticky-top">
               ...
               <div class="widget-area notepad">
                  ...
                  <div class="list-group">
                     <a href="#" class="list-group-item list-group-item-action active">{{$related->name}}</a>
                  </div>
                  @endforeach
                  <!-- /list-group -->
               </div>
