        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <a href="#" class="btn btn-success btn-sm"> Lưu </a>
              <a href="{{URL::to('/admin/add-news')}}" class="btn btn-primary btn-sm"> Thêm tin tức </a>
            ...
            <table class="list_banners table table-striped projects bulk_action" id="myTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <img src="{{URL::to('public/backend/uploads/news/'.$news->image)}}" height="auto"
                      width="80">
                  </td>
                  <td>
                    <a>{{ $news->name }}</a>
                  ...
                  <td><span class="text-ellipsis">
                      ...
                      <a href="{{URL::to('/admin/unactive-news-status/'.$news->id)}}"><span class="fa fa-toggle-on"
                          style="font-size: 25px;"></span></a>
                      <?php } else { ?>
                      <a href="{{URL::to('/admin/active-news-status/'.$news->id)}}"><span class="fa fa-toggle-off"
                          style="font-size: 25px;"></span></a>
                      <?php } ?>
                    </span>
                  </td>
                  <td>
                    ...
                    <a href="{{URL::to('/admin/edit-news/'.$news->id)}}"
                      class="btn btn-info btn-xs btn-sm"><i class="fa fa-pencil"></i> Sửa</a>
                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa không?')"
                      href="{{URL::to('/admin/delete-news/'.$news->id)}}"
