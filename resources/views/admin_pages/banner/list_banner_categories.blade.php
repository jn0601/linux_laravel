        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <a href="#" class="btn btn-success btn-sm"> Lưu </a>
              <a href="{{URL::to('/admin/add-banner-categories')}}" class="btn btn-primary btn-sm"> Thêm danh mục </a>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{URL::to('/admin/edit-banner-categories/'.$banner_cate->id)}}"
                    ...
                    <a onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này ko?')"
                      href="{{URL::to('/admin/delete-banner-categories/'.$banner_cate->id)}}"
