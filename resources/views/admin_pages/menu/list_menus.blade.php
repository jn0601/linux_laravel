        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <a href="#" class="btn btn-success"> Lưu </a>
              <a href="{{URL::to('/add-menus')}}" class="btn btn-primary"> Thêm menu </a>
            ...
            <table class="list_banners table table-striped projects bulk_action" id="myTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <img src="public/backend/uploads/menus/{{ $menu->icon }}" height="auto"
                      width="80">
                  </td>
                  <td>
                    <a>{{ $menu->name }}</a>
                  ...
                  <td><span class="text-ellipsis">
                      ...
                      <a href="{{URL::to('/unactive-menus-status/'.$menu->id)}}"><span class="fa fa-toggle-on"
                          style="font-size: 25px;"></span></a>
                      <?php } else { ?>
                      <a href="{{URL::to('/active-menus-status/'.$menu->id)}}"><span class="fa fa-toggle-off"
                          style="font-size: 25px;"></span></a>
                      <?php } ?>
                    </span>
                  </td>
